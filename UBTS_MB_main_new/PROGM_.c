...
const uint8_t _Tpa1[] PROGMEM="  tpa1=";
const uint8_t _Tpa2[] PROGMEM="  tpa2=";
const uint8_t _Tpa3[] PROGMEM="  tpa3=";
const uint8_t _Tpa4[] PROGMEM="  tpa4=";
...
const uint8_t _INA_CURRENT[] PROGMEM="  I=";
//const uint8_t _INA_ID[] PROGMEM="\nID=";
const uint8_t _INA_POWER[] PROGMEM="  W=";
...
const uint8_t _ADC_OUT_PA_2[] PROGMEM="  PA_OUT2=";
const uint8_t _ADC_OUT_PA_3[] PROGMEM="  PA_OUT3=";
//const uint8_t _ADC_OUT_PA_4[] PROGMEM="\nPA4=";
const uint8_t _ADC_BW_PA_1[] PROGMEM="\nPA_BW1=";
const uint8_t _ADC_BW_PA_2[] PROGMEM="  PA_BW2=";
const uint8_t _ADC_BW_PA_3[] PROGMEM="  PA_BW3=";
//const uint8_t _ADC_BW_PA_4[] PROGMEM="\nPA_BW4=";

const uint8_t _PA1[] PROGMEM="\nPA1=";
const uint8_t _PA2[] PROGMEM="  PA2=";
const uint8_t _PA3[] PROGMEM="  PA3=";
...
const uint8_t _ERROR_I2C[] PROGMEM ="\n%error_i2c*";